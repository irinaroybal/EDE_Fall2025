...
```{r Ozone 2018, echo = FALSE, fig.width = 5, fig.height = 3, fig.cap = "2018 Monthly Ozone Levels", fig.align = "left", warning = FALSE}
...
plot1 <-
  ...
  ggplot(aes(x = factor(Month, 
                        ...
                        y = Ozone)) +
  geom_boxplot()+
  labs(title = "Monthly Ozone Concentrations")+
  xlab("Month")+
  ylab("Concentration (mu g/m^3)" )

plot1

```

```{r Ozone 2019, echo = FALSE, warning = FALSE, fig.width = 5, fig.height = 3, fig.cap = "2019 Monthly Ozone Levels", fig.align = "left"}
plot2 <-
  epa_data %>%
  filter(Year == 2019) %>%
  ggplot(aes(x = factor(Month, 
...
>Irina Roybal, 10/21/2025

## Git Repository
https://github.com/irinaroybal/EDE_Fall2025/tree/main
